...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        try:
            ...
            raise Exception(
                f'{prefix}Error loading config from {path}: {e}\nSee {HELP_URL}')
...
def load_mosaic(self, index):
    ...
    # output_img = np.full([1280, 1280, 3], 114, dtype=np.uint8)
    # scale_range = (0.4, 0.6)
    labels4, segments4 = [], []
    s = self.img_size
    ...
    #     random.random() * (scale_range[1] - scale_range[0])
    # divid_point_x = int(scale_x * 1280)
    # divid_point_y = int(scale_y * 1280)
    ...
    for i, index in enumerate(indices):
        ...
        # elif i == 1:  # top-right
        #     img = cv2.resize(
        #         img, (1280 - divid_point_x, divid_point_y))
        #     output_img[:divid_point_y, divid_point_x:1280, :] = img
        # elif i == 2:  # bottom-left
        #     img = cv2.resize(
        #         img, (divid_point_x, 1280 - divid_point_y))
        #     output_img[divid_point_y:1280, :divid_point_x, :] = img
        # else:  # bottom-right
        #     img = cv2.resize(
        #         img, (1280 - divid_point_x, 1280 - divid_point_y))
        #     output_img[divid_point_y:1280,
        #                divid_point_x:1280, :] = img
